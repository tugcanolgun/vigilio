...
Feel free to [open a ticket](https://github.com/tugcanolgun/vigilio/issues/new) with your question. Feature requests
...
- You are using the [latest version](https://github.com/tugcanolgun/vigilio/releases).
- You have read the [documentation](https://docs.vigilio.tugcan.net) first, and
...
* Follow instructions for how to run vigilio for development on the [documentation](https://docs.vigilio.tugcan.net).
...
If everything is okay, push your changes.
